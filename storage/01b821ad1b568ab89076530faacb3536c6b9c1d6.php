    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <img src="<?php echo e($products->image); ?>" alt="" width="100">
                </td>
                <td><?php echo e($products->price); ?></td>
                <td>
                    <a href="./edit-product?id=<?php echo e($products->id); ?>">Edit</a>
                    <a href="./remove-product?id=<?php echo e($products->id); ?>">Remove</a>
                </td>
...
</html><?php /**PATH C:\xampp\htdocs\PHP2\PT15211-PHP2\mvc\app\views/home/product.blade.php ENDPATH**/ ?>